...
public class Cancel_Order extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // modelList = new ArrayList<>();
        ...
        adapter = new CurrentOrder_Adapter(Cancel_Order.this,modelList);
        ...
        call.enqueue(new Callback<String>() {
            ...
            public void onResponse(Call<String> call, Response<String> response) {
                ...
                try {
                    ...
                    Toast.makeText(Cancel_Order.this, "Somthing went wrong", Toast.LENGTH_SHORT).show();
                    progressDialog.dismiss();
                    swipyRefreshLayout.setRefreshing(false);
                }
            }
            ...
            public void onFailure(Call<String> call, Throwable t) {
                ...
                Toast.makeText(Cancel_Order.this, "Slow Network", Toast.LENGTH_SHORT).show();
                progressDialog.dismiss();
                swipyRefreshLayout.setRefreshing(false);
            }
        });
